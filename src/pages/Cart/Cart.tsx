...
import noproduct from 'src/apis/assets/img/noproduct.png'
export default function Cart() {
  ...
  const handleQuantity = (purchaseIndex: number, value: number, enable: boolean) => {
    if (enable) {
      ...
      setExtendedPurchases(
        produce((drafe) => {
          drafe[purchaseIndex].disabled = true
        })
      )
  ...
  const handleTypeQuantity = (purchaseIndex: number) => (value: number) => {
    setExtendedPurchases(
      produce((drafe) => {
        drafe[purchaseIndex].buy_count = value
      })
    )
  }
  // delete
  ...
  const handleDelte = (purchaseIndex: number) => () => {
